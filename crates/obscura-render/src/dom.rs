...
use crate::dom_floats::{build_children_with_float_zone, build_children_with_native_float_band, can_use_native_float_band, max_definite_table_content_width};
...
pub(crate) struct IfcRegistry {
    pub(crate) whole: HashMap<NodeId, usize>,
    pub(crate) runs: HashMap<NodeId, Vec<usize>>,
    pub(crate) word_items: HashMap<NodeId, Vec<usize>>,
    pub(crate) generated: Vec<GeneratedBoxBuild>,
    ...
    pub(crate) table_cols: HashMap<taffy::NodeId, (Vec<Option<f32>>, Vec<Option<f32>>)>,
    ...
    pub(crate) fixed_table_cols: HashMap<taffy::NodeId, Vec<FixedTableColumn>>,
    ...
    pub(crate) table_rows: HashMap<taffy::NodeId, Vec<Option<f32>>>,
    ...
    pub(crate) float_continuations: Vec<FloatContinuation>,
    ...
    /// border-box width.
    pub(crate) float_aware_blocks: HashSet<NodeId>,
    ...
    pub(crate) multicol: Vec<MulticolBuild>,
}

#[derive(Clone, Copy, Debug, Default)]
pub(crate) struct FixedTableColumn {
    pub(crate) length: f32,
    pub(crate) percentage: f32,
    pub(crate) specified: bool,
}
...
#[derive(Clone, Copy)]
pub(crate) struct FloatContinuation {
    pub(crate) owner: NodeId,
    pub(crate) float: taffy::NodeId,
    pub(crate) flow: taffy::NodeId,
...
pub(crate) fn synthesize_ordinary_inline_fragments(
...
#[cfg(feature = "paint")]
pub(crate) fn synthesize_shaped_inline_fragments(
    tree: &DomTree,
    rects: &mut HashMap<NodeId, Rect>,
    styles: &HashMap<NodeId, crate::LayoutStyle>,
    engine: &crate::inline::TextEngine,
...
#[cfg(feature = "paint")]
pub(crate) fn folded_inline_relative_offset(
    tree: &DomTree,
    owner: NodeId,
    rects: &HashMap<NodeId, Rect>,
    styles: &HashMap<NodeId, crate::LayoutStyle>,
...
pub(crate) fn container_snapshot(tree: &DomTree, layout: &DomLayout) -> crate::css::ContainerSnapshot {
    let root_font_size = tree
        .descendants(tree.document())
        .into_iter()
        .find(|id| tree.get_node(*id).is_some_and(|node| node.is_element()))
...
pub(crate) fn style_children(tree: &DomTree, id: NodeId) -> Vec<NodeId> {
...
pub(crate) fn has_inline_content(
    tree: &DomTree,
    id: NodeId,
    styles: &HashMap<NodeId, crate::LayoutStyle>,
) -> bool {
...
pub(crate) fn blockify_layout_children(
    tree: &DomTree,
    parent: NodeId,
    styles: &mut HashMap<NodeId, crate::LayoutStyle>,
) {
...
/// cannot reach them.
pub(crate) fn blockify_generated_pseudos(styles: &mut HashMap<NodeId, crate::LayoutStyle>) {
...
pub(crate) fn build_shaped_word_leaves(
    source_id: NodeId,
    text: &str,
    style: &crate::LayoutStyle,
    taffy_tree: &mut TaffyTree<usize>,
...
pub(crate) fn build_word_leaves(
    source_id: NodeId,
    text: &str,
    fsize: f32,
    line_height: f32,
...
pub(crate) fn build_pseudo_content(
    id: NodeId,
    content: &str,
    style: &crate::LayoutStyle,
    taffy_tree: &mut TaffyTree<usize>,
...
pub(crate) fn pseudo_requires_generated_box(style: &crate::LayoutStyle, content: Option<&str>) -> bool {
    content == Some("")
...
pub(crate) fn has_in_flow_generated_pseudo(pseudo: Option<&crate::LayoutStyle>) -> bool {
...
/// container.
pub(crate) fn build_in_flow_pseudo(
    host: NodeId,
    kind: GeneratedBoxKind,
...
pub(crate) fn tokenize_with_spaces(text: &str) -> Vec<String> {
...
pub(crate) fn effective_container_type(style: &crate::LayoutStyle) -> crate::ContainerType {
    if style.internal_flex_container
        || style.is_table_box
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn build_mixed_block(
    tree: &DomTree,
    id: NodeId,
    style: &crate::LayoutStyle,
...
pub(crate) fn flatten_contents_children(
    tree: &DomTree,
    children: &[NodeId],
    styles: &HashMap<NodeId, crate::LayoutStyle>,
    out: &mut Vec<NodeId>,
